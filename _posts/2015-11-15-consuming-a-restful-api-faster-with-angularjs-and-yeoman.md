...
comments: true
excerpt: "To change a little bit the 'Rails wave' of my previous posts, I want to touch other web technology. Due to the fact that I'm going to start a development with AngularJS near, I think that could be great to share a fast way to introduce you to the AngularJS world..."
post_summary: "To change a little bit the 'Rails wave' of my previous posts, I want to touch other web technology. Due to the fact that I'm going to start a development with AngularJS near, I think that could be great to share a fast way to introduce you to the AngularJS world..."
image:
...
<div class="row marketing">
  <div class="form-group col-md-12" style="display:inline;">
    <div class="input-group">
      <input class="form-control" placeholder="What are searching for?"
             type="text" ng-model="search" ng-change="change()">
  ...
  <div class="form-group col-md-12" style="display:inline;">
    <div class="input-group col-md-12">
      <select class="form-control" name="limit"
              ng-model="limit" ng-change="change()">
  ...
  <div class="form-group col-md-12" style="display:inline;">
    <div class="input-group col-md-12">
      <select class="form-control" name="method"
              ng-model="method" ng-change="change()">
...
![screenshot](/images/2015-11-15-consuming-a-restful-api-faster-with-angularjs-and-yeoman/screenshot3.png)
